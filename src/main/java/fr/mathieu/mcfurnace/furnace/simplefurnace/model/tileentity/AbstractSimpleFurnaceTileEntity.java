package fr.mathieu.mcfurnace.furnace.simplefurnace.model.tileentity;
...
public abstract class AbstractSimpleFurnaceTileEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
        ...
        protected final IIntArray furnaceData = new IIntArray() {
            public int get(int index) {
                switch(index) {
                    case 0:
                        return AbstractSimpleFurnaceTileEntity.this.burnTime;
                    case 1:
                        return AbstractSimpleFurnaceTileEntity.this.recipesUsed;
                    case 2:
                        return AbstractSimpleFurnaceTileEntity.this.cookTime;
                    case 3:
                        return AbstractSimpleFurnaceTileEntity.this.cookTimeTotal;
                    default:
                        return 0;
                }
            }
            ...
            public void set(int index, int value) {
                switch(index) {
                    case 0:
                        AbstractSimpleFurnaceTileEntity.this.burnTime = value;
                        break;
                    case 1:
                       AbstractSimpleFurnaceTileEntity.this.recipesUsed = value;
                        break;
                    case 2:
                        AbstractSimpleFurnaceTileEntity.this.cookTime = value;
                        break;
                    case 3:
                        AbstractSimpleFurnaceTileEntity.this.cookTimeTotal = value;
    ...
    public AbstractSimpleFurnaceTileEntity(TileEntityType<?> tileTypeIn, IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn, int cookSpeed, int extraOutput) {
        super(tileTypeIn);
            ...
            if (!this.items.get(0).isEmpty() && recipeIn != null) {
                ...
                if (itemstack.isEmpty()) {
                    ...
                    if (itemstack1.isEmpty()) {
                        ...
                        return false;
                    } else return itemstack1.getCount() + itemstack.getCount() <= 64;
                }
            } else {
                return false;
            }
        ...
        private void func_214007_c(@Nullable IRecipe<?> p_214007_1_) {
            if (p_214007_1_ != null && this.canSmelt(p_214007_1_)) {
                ...
                if (itemstack2.isEmpty()) {
                    ...
                    itemstack1.setCount(extraOutput);
                    this.items.set(2, itemstack1.copy());

                } else if (itemstack2.getItem() == itemstack1.getItem()) {

                    itemstack2.grow(extraOutput);
                }
