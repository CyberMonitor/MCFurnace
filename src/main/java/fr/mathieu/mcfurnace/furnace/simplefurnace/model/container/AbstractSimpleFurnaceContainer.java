package fr.mathieu.mcfurnace.furnace.simplefurnace.model.container;


import fr.mathieu.mcfurnace.furnace.simplefurnace.model.slot.SimpleFurnaceFuelSlot;
import fr.mathieu.mcfurnace.furnace.simplefurnace.model.slot.SimpleFurnaceResultSlot;
...
public class AbstractSimpleFurnaceContainer  extends RecipeBookContainer<IInventory> {
    ...
    public AbstractSimpleFurnaceContainer(ContainerType<?> containerTypeIn, IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn, int id, PlayerInventory playerInventoryIn, IInventory furnaceInventoryIn, IIntArray p_i50104_6_) {
        ...
        this.addSlot(new SimpleFurnaceFuelSlot(this, furnaceInventoryIn, 1, 56, 53));

        this.addSlot(new SimpleFurnaceResultSlot(playerInventoryIn.player, furnaceInventoryIn, 2, 116, 35));
    ...
    public boolean isFuel(ItemStack p_217058_1_) {
        return AbstractSimpleFurnaceTileEntity.isFuel(p_217058_1_);
    }
